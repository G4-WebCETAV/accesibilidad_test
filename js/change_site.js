...
function change_param(param){
    ...
    switch(param){
        case 1:
            change_img.innerHTML = '<a target="_blank" href="http://www.tecnobility.com"><img src="../../img/pag1.png" alt="Esta imagen muestra una captura de un sitio web, utilizado como portal de noticias para informar a las personas con discapacidad de una manera accesible."></a>';
        ...
        case 3:
            change_img.innerHTML = '<a target="_blank" href="http://www.hosteleriaaccesible.es/"><img src="../../img/pag3.png" alt="Esta imagen muestra la captura de un sitio web que realiza una recopilación de hosteles que va dirigido a las personas con discapacidad."></a>';
        ...
        case 6:
            change_img.innerHTML = '<a target="_blank" href="http://www.fundacioncnse.org/educa/internet_seguro/"><img src="../../img/pag6.png" alt="Esta imagen muestra una captura de un sitio web que brinda accesibilidad para un uso adecuado en el internet y las redes sociales para niños sordos."></a>';
