...
let param = paramer;
let arr_text1 = [
    'http://www.tecnobility.com',
    'http://equiposespecializados.catedu.es/',
    'http://www.hosteleriaaccesible.es/',
    'http://www.cnse.es/',
    'http://www.nomasabuso.com/',
    'http://www.fundacioncnse.org/educa/internet_seguro/',
    'http://www.cocemfe.es/portal/',
    'http://www.fundacioncnse.org/dgt/'
]
let arr_text = [
...
change_img.innerHTML = '<a target="_blank" href="' + arr_text1[param-1] + '"><img src="../../img/pag' + param + '.png" alt="Esta imagen muestra una captura de un sitio web, utilizado como portal de noticias para informar a las personas con discapacidead de una manera accesible."></a>';
...
function change_param(param){
    ...
    switch(param){
        case 1:
            change_img.innerHTML = '<a target="_blank" href="http://www.tecnobility.com"><img src="../../img/pag1.png" alt="Esta imagen muestra una captura de un sitio web, utilizado como portal de noticias para informar a las personas con discapacidead de una manera accesible."></a>';
            text_on_p.innerHTML = 'Es el primer medio de comunicación ‘online’ a nivel mundial, independiente y con una actualización constante, especializado en tecnología dirigida a personas con discapacidad y personas mayores. El portal de noticias incorpora en la cabecera la posibilidad de personalizar la portada, de manera que los visitantes pueden elegir el tipo de información sobre el que están más interesados (por tipo de discapacidad: visual, auditiva, física, cognitiva u otras, o para personas mayores) y todas las noticias de portada cambian para mostrar aquellas que interesan al usuario.';
            break;

        case 2:
            change_img.innerHTML = '<a target="_blank" href="http://equiposespecializados.catedu.es/"><img src="../../img/pag2.png" alt="Esta imagen muestra una captura de un ditio web, utilizado con un portal de noticias "personalizado" para cada usuario dependiendo de su discapacidad.></a>';
        ...
        case 3:
            change_img.innerHTML = '<a target="_blank" href="http://www.hosteleriaaccesible.es/"><img src="../../img/pag3.png" alt="Esta imagen muestra la captura de un sitio web que realiza una recopilación de hosteles quer va dirigido a las personas con discapacidad."></a>';
        ...
        case 4:
            change_img.innerHTML = '<a target="_blank" href="http://www.cnse.es/"><img src="../../img/pag4.png" alt="Esta imagen muestra la captura de un sitio web que brinda accesibilidad web a personas sordas, por medio de videos en lengua de signos, recursos visuales de aumento de texto y descripciones"></a>';
        ...
        case 5:
            change_img.innerHTML = '<a target="_blank" href="http://www.nomasabuso.com/"><img src="../../img/pag5.png" alt="Esta imagen muestra una captura de un sitio web, que brinda recursos como lectura fácil, con un cuerpo de letra mayor, vídeos sencillos con ilustraciones y audio de fácil comprensión para personas con discapacidad."></a>';
        ...
        case 6:
            change_img.innerHTML = '<a target="_blank" href="http://www.fundacioncnse.org/educa/internet_seguro/"><img src="../../img/pag6.png" alt="Esta imagen muestra una captura de un sitio web que brinda accesibilidad para un uso adecuado en el internet y las redes sociuales para niños sordos."></a>';
        ...
        case 7:
            change_img.innerHTML = '<a target="_blank" href="http://www.cocemfe.es/portal/"><img src="../../img/pag7.png" alt="Esta imagen muestra una captura de un sitio web que brinda información laboral para personas con discapacidad de una manera accesible."></a>';
        ...
        case 8:
            change_img.innerHTML = '<a target="_blank" href="http://www.fundacioncnse.org/dgt/"><img src="../../img/pag8.png" alt="Esta imagen muestra una captura de un sitio web que brinda el reglamento para el examen de licencia de conducir a personas con discapacidad, de una manera accesible."></a>';
